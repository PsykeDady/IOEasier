...
import psykeco.ioeasier.db.SQLClassParser;
 ...
 * @author psykedady
 **/
public class SQLCreateTableCraft implements TableCraft{
	...
	public SQLCreateTableCraft(String db, Class c) {
		this.db=db;
		table=SQLClassParser.getTrueName(c);
		kv=SQLClassParser.parseClass(c);
	}
	
	@Override
	public SQLCreateTableCraft db(String db) {
		this.db=db;
		return this;
	}
	...
	@SuppressWarnings("rawtypes")
	@Override
	public SQLCreateTableCraft table(Class c) {
		table=SQLClassParser.getTrueName(c);
		kv=SQLClassParser.parseClass(c);
		return this;
	}
	...
	public SQLCreateTableCraft suffix(String suffix) { 
		if(suffix!=null)
			this.suffix=suffix; 
		return this; 
	}
	...
	public SQLCreateTableCraft prefix(String prefix) { 
		if(prefix!=null)
			this.prefix=prefix; 
		return this; 
	}
	...
	public SQLCreateTableCraft primary(String key) { 
